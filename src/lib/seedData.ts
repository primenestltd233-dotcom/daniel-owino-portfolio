...
export const initialFreelanceServices: FreelanceServicesSection = {
  ...
  services: [
    { id: 'srv-1', iconName: 'Image', label: 'Designing Birthday Banners', order: 1 },
    { id: 'srv-2', iconName: 'Sparkles', label: 'Designing Birthday Cards', order: 2 },
    { id: 'srv-3', iconName: 'Church', label: 'Church Flyers', order: 3 },
    { id: 'srv-4', iconName: 'Share2', label: 'Social Media Flyers', order: 4 },
    { id: 'srv-5', iconName: 'Building2', label: 'Business Flyers', order: 5 },
    { id: 'srv-6', iconName: 'Code', label: 'Web Design & Development', order: 6 },
    { id: 'srv-7', iconName: 'Terminal', label: 'DevOps Services', order: 7 },
    { id: 'srv-8', iconName: 'ShieldAlert', label: 'Cybersecurity Analysis', order: 8 },
  ],
  stats: [
